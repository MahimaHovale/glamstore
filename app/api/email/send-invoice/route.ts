...
export async function POST(request: NextRequest) {
  try {
    ...
    const mailOptions = {
      ...
      to: customerEmail,
      subject: `Your GlamStore Invoice #${order.id?.substring(0, 8)}`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #333;">
          ...
          <div style="padding: 20px;">
            ...
            <p>Best regards,<br>GlamStore Beauty Team</p>
          </div>
          
          <div style="background-color: #333; color: #fff; padding: 15px; text-align: center; font-size: 12px;">
            <p>© ${new Date().getFullYear()} GlamStore Beauty. All rights reserved.</p>
      ...
      attachments: [
        {
          filename: `GlamStore-Invoice-${order.id?.substring(0, 8)}.html`,
          content: invoiceHTML,
