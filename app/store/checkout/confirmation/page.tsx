    ...
    <AuthGuard>
      <div className="container max-w-4xl mx-auto py-6 sm:py-8 px-4 sm:px-6 flex flex-col items-center justify-center">
        <div className="mb-4 sm:mb-6 w-full max-w-4xl">
          <h1 className="text-2xl sm:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-pink-600 to-purple-600 mb-2 text-center">
            Review & Confirm Order
          </h1>
          <div className="overflow-x-auto pb-2 mb-4">
            <div className="flex items-center space-x-1 md:space-x-2 min-w-max">
              <div className="flex items-center justify-center w-5 h-5 md:w-6 md:h-6 rounded-full bg-pink-600 text-white">
          ...
          <Card className="shadow-md mb-6 dark:bg-gray-800 dark:border-gray-700">
            ...
            <CardContent className="space-y-4 sm:space-y-6 p-3 sm:p-6">
              ...
              <div>
                ...
                <Button 
                  variant="link" 
                  className="p-0 h-auto text-pink-600 dark:text-pink-400 mt-2 text-sm"
            ...
            <CardFooter className="pt-4 sm:pt-6 border-t dark:border-gray-700 flex flex-col">
              <Button
                className="w-full bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 text-white font-medium py-2 h-auto mb-3 dark:from-pink-700 dark:to-purple-700 dark:hover:from-pink-800 dark:hover:to-purple-800"
