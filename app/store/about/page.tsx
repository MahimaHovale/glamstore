...
export const metadata = {
  title: "About Us | GlamStore",
  description: "Learn more about GlamStore and our story",
};
  ...
  return (
    <div className="container mx-auto py-12 px-4">
      <div className="max-w-5xl mx-auto">
        <h1 className="text-4xl font-bold mb-8 text-center bg-clip-text text-transparent bg-gradient-to-r from-pink-600 to-purple-600">About GlamStore</h1>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16 items-center">
          <div>
            <h2 className="text-2xl font-semibold mb-4 text-pink-600">My Story</h2>
            <p className="text-muted-foreground mb-4">
              GlamStore is an e-commerce project I developed during my internship at Ultimez Technology Pvt Ltd. This project was created to showcase my web development skills and understanding of modern e-commerce platforms.
            </p>
            <p className="text-muted-foreground mb-4">
          ...
          <div className="bg-pink-50 dark:bg-pink-950/20 p-6 rounded-lg shadow-sm border border-pink-100 dark:border-pink-800">
            <h3 className="text-xl font-medium mb-4 text-pink-600">Project Overview</h3>
            <p className="text-muted-foreground mb-4">
            ...
            <h3 className="text-xl font-medium mb-4 text-pink-600 mt-6">Technical Features</h3>
        ...
        <div className="mb-16">
          <h2 className="text-2xl font-semibold mb-6 text-pink-600 text-center">Technologies Used</h2>
        ...
        <div className="mb-16">
          <h2 className="text-2xl font-semibold mb-6 text-pink-600 text-center">About the Developer</h2>
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="relative w-48 h-48 rounded-full overflow-hidden flex-shrink-0 border-4 border-pink-200 shadow-md mx-auto md:mx-0">
              <Image 
            ...
            <div>
              ...
              <p className="text-muted-foreground mb-4">
                With a passion for beauty and technology, I created GlamStore to provide a better online shopping experience for beauty enthusiasts. My background in computer science and love for cosmetics inspired me to build this platform from the ground up.
              </p>
              <p className="text-muted-foreground">
                "I believe that everyone deserves access to high-quality beauty products that make them feel confident and beautiful. GlamStore is my way of making that possible."
              </p>
              ...
              <div className="flex items-center space-x-4 mt-6 justify-center md:justify-start">
                <a 
                  ...
                  className="flex items-center text-muted-foreground hover:text-pink-600 transition-colors duration-200"
                >
        ...
        <div className="text-center">
          <h2 className="text-2xl font-semibold mb-4 text-pink-600">Explore the Project</h2>
