...
export default function SignInPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-pink-50 via-purple-50 to-pink-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 px-4 sm:px-6 lg:px-8 py-10">
          ...
          appearance={{
            ...
            ...(isDarkMode ? {
              ...
              elements: {
                ...
                formButtonPrimary: "bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-700 hover:to-purple-700 text-white",
                footerActionText: "text-gray-400",
                footerActionLink: "text-pink-400 hover:text-pink-300",
                formFieldInput: "border-gray-600 bg-gray-700 text-white focus:border-pink-500 focus:ring-pink-500",
